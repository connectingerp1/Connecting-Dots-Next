...
export default function Achievements() {
  return (
    <main class="relative w-full max-w-[1800px] mx-auto overflow-hidden py-12 px-4 m-10 bg-gradient-to-br from-[#65b9fe] via-[#103357] to-[#4f498b] dark:from-[#65b9fe] dark:via-[#103357] dark:to-[#4f498b] flex items-center">
