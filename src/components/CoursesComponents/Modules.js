  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        if (pageData) {
          localStorage.setItem(`curriculum_${pageId}`, JSON.stringify(pageData));
          setData(pageData);
        } else {
    ...
    <div className={styles.containerDs}>
      ...
      <div className={styles.contentContainer}>
        <div className={styles.content}>
          {data.tabs
            ...
            .modules.map((module, index) => (
              <div
                key={index}
                className={`${styles.module} ${activeModule === index ? styles.selected : ''}`}
        ...
        <div className={styles.moduleDetailsContainer}>
          {activeContent && (
            <div className={`${styles.moduleDetails} ${styles.expanded}`}>
