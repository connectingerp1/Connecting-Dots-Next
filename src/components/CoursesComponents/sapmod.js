    ...
    <div className={styles.sapModContainer}>
      ...
      <div className={styles.sapModCard}>
        ...
        <div className={styles.sapModButtonContainer}>
          <button className={styles.sapModButton} onClick={handleDownloadBrochureClick}>
            Download Brochure
          </button>

          <video src={data.videoUrl} className={styles.downloadVideo} autoPlay loop muted />
        </div>
      </div>
      ...
      <div className={`${styles.sapModCard} ${styles.sapModCardSecondary}`}>
        ...
        <div className="space-y-">
          {data.overview.modules && data.overview.modules.length > 0 ? (
            data.overview.modules.map((module, index) => (
              <div key={index} className={`${styles.sapModCardContent} ${index % 2 === 1 ? styles.alt : ""}`}>
