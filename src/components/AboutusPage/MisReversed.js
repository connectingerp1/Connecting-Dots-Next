...
const MisReversed = ({ pageId }) => {
  ...
  return (
    <div className={styles.missionReversed}>
      <div className={styles.missionContainer}>
        <div className={styles.missionRow}>
          <div className={styles.missionCol12}>
            <h1>{missionData.missionTitle}</h1>
          </div>
        </div>
        <div className={styles.missionRow}>
          <div className={`${styles.missionCol12} ${styles.missionColLg6}`}>
            <div
